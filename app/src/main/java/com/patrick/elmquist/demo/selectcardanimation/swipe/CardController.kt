package com.patrick.elmquist.demo.selectcardanimation.swipe
...
open class CardControllerImpl(
    ...
    companion object {
        private const val SWIPE_DURATION_IN_MILLIS = 350
    }
    ...
    override fun onDragEnd() {
        ...
        // out of bounds.
        val isSwipedOneThird = abs(swipeX.targetValue) > abs(screenWidth) / 5
        if (isSwipedOneThird) {
            // Card's 1/3 is out
